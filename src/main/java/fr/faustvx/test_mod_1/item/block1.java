...
public class block1
{
    ...
    public static final RegistryObject<BlockItem> BLOCK1 = ITEMS.register("block1", block1::create_item);

    private static BlockItem create_item()
    {
        LOGGER.info("created block_item: {}", BLOCK1.getId());
        return new BlockItem(fr.faustvx.test_mod_1.block.block1.BLOCK1.get(),
            new Item.Properties()
